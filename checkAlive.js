...
/* While making a game, your partner, Greg, decided to create a function to check if the user is still alive called checkIfAlive. Unfortunately, Greg made some errors while creating the function.
